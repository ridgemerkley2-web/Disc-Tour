#!/usr/bin/env python3
"""Run the Session 8 cook-closure proof in one isolated packaged process.
...
DEFAULT_REPORT = (
    ROOT / "Saved/CharacterFramework/Session8CookClosureSmoke.json"
)
DEFAULT_LOG = ROOT / "Saved/Logs/Session8CookClosureSmoke.log"
...
def main() -> int:
    ...
    owned_marker = user_dir / ".dg_session8_cook_closure_owned"
    try:
        user_dir.mkdir()
    ...
    result = {
        "schema": "DiscGolfTour.Session8CookClosureSmoke.v1",
