 ...
 */
UCLASS()
class DISCGOLFTOURDEVELOPER_API ADiscGolfSession3SmokeRunner : public AActor
{
    GENERATED_BODY()
...
protected:
    ...
    bool bRequireV006ProductionProfileProof = false;
    bool bFinished = false;
    FString ProductionProfileProofName;
    FString ProductionProfileProofMontagePath;
