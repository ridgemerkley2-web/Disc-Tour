...
bool FPCGDiscGolfZoneDensityElement::ExecuteInternal(FPCGContext* InContext) const
{
    ...
    return ExecutePointOperation(Context,
        [Controller, Category, Preset, Zones, AssetSlot, bShouldWriteMeshAttribute, MeshAttributeName]
            ...
            int32 StartIndex, int32 Count)
        {
            ...
            FPCGMetadataAttribute<FSoftObjectPath>* MeshAttribute = bShouldWriteMeshAttribute
