...
/** Editor-only PCG node that evaluates the project-owned environment-zone plan. */
UCLASS(BlueprintType, ClassGroup=(Procedural))
class DISCGOLFTOUREDITOR_API UPCGDiscGolfZoneDensitySettings : public UPCGSettings
{
    GENERATED_BODY()
...
public:
    ...
    /** Writes a mesh reference selected from the preset asset set for a by-attribute spawner. */
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Category="Disc Golf Environment", meta=(PCG_Overridable))
