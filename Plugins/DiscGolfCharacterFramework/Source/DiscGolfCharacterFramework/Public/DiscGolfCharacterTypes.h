...
struct DISCGOLFCHARACTERFRAMEWORK_API FDGBodyProfile
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame, Category="Body", meta=(ClampMin="150.0", ClampMax="210.0"))
    float HeightCm = 183.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame, Category="Body", meta=(ClampMin="0.90", ClampMax="1.10"))
    float WingspanScale = 1.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame, Category="Body", meta=(ClampMin="0.90", ClampMax="1.10"))
    float ShoulderWidthScale = 1.0f;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame, Category="Body", meta=(ClampMin="0.92", ClampMax="1.08"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame, Category="Body", meta=(ClampMin="45.0", ClampMax="160.0"))
    float MassKg = 82.0f;
};
...
struct DISCGOLFCHARACTERFRAMEWORK_API FDGThrowStyle
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame, Category="Throw Style", meta=(ClampMin="0.0", ClampMax="1.0"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, SaveGame, Category="Throw Style", meta=(ClampMin="0.75", ClampMax="1.25"))
